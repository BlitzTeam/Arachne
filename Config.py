...
def configLegs(motors, simulator = True):
	if simulator:
		return (	Leg(60.0, 0, 0, Servo(motors[0], offset = 30), Servo(motors[1]), Servo(motors[2], offset = 90)), 
					Leg(120.0, 0, 0, Servo(motors[15]), Servo(motors[16]), Servo(motors[17], offset = 90)), 
					Leg(180.0, 0, 0, Servo(motors[12], offset = -30), Servo(motors[13]), Servo(motors[14], offset = 90)), 
					Leg(240.0, 0, 0, Servo(motors[9], offset = 30), Servo(motors[10]), Servo(motors[11], offset = 90)),
					Leg(300.0, 0, 0, Servo(motors[6]), Servo(motors[7]), Servo(motors[8], offset = 90)),
